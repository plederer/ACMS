...
if Href == 0:
    ...
    Errors_FEM, Errors_exact = main(maxH, problem, omega, order_v, Bubble_modes, Edge_modes) 
    ...
    for h in maxH/(2**np.arange(0, Href, 1)):
        print(h)
        Errors_FEM, Errors_exact = main(h, problem, omega, order_v, Bubble_modes, Edge_modes) 
